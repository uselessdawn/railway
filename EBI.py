...
###---------------------EBI------------------------------
# # 绘制曲线
# for L0, v0 in falling_points:
#     L_values = np.linspace(L0, max(final_x_values), 500)  # 从跌落点到最大横坐标
#     v_values = v0 + np.sqrt(2 * 0.8 * (L0 - L_values))
#     ax.plot(L_values, v_values, color='green')
